...
\item[(ii)] The left-most head linear reduction strategy terminates iff the head linear reduction terminates.
\item[(iii)] If $M$ is in quasi normal form and contains $n$ standard redexes then there is an evaluation strategy that reduces $M$ to its normal form in $n$ beta-reduction steps.
\end{itemize}
\end{theorem}
\begin{proof}
