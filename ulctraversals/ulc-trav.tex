...
%(ii) we do not bother renaming the variable occurrences when a variable get renamed via $\otimes$, this is because the name of variable occurrences can always be recovered from its justifier and justification label.)
\end{definition}
