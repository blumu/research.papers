...
we performs the necessary ``gymnastics to find the argument of a subterm''\cite{danos-head} by traversing the `pending argument lookup` (Definition~\ref{def:spinaldescent_pendingarglookup}) consisting of ghost occurrences, until
