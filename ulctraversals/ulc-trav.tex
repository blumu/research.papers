...
\end{proof}
\todo{TODO: Find alternative proof based on a traversal argument without appealing to strong normalization of leftmost linear reduction.}
...
\end{proof}
\todo{TODO: Find alternative proof based on a traversal argument without appealing to strong normalization of leftmost linear readuction.}
...
\FORALL{node $n \in P$ (by depth-first enumeration)}
    ...
    \ELSIF{$n \in\ghostlmd$}
        ...
        \COMMENT{Will be used as prefix to name variables bound by this node }
    ...
    \ELSIF{$n \in\ghostvar$}
            ...
            \COMMENT{Get the name prefix previously assigned to the binder}
