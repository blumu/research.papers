...
\begin{compactitem}
\item[(i)] The sequence $t$ is a valid justified sequence, with respect to enabling relation $\enables$ extended to ghost nodes, and $t$ verifies the alternation condition;
