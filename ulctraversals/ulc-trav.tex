...
\item $t$ does not contain any internal variable node;
...
\item Let $t_{max}$ be a maximal extension of $t$.
    ...
    $$\underline{\lambda\overline{\eta}} \cdot u_1 \cdot \underline{x_1}$$ where
        \begin{itemize}
        \item $u_1$ is a (possibly empty) \emph{spinal descent} (internal nodes),
        \item $x_1$ is a structural external variable nodes.
        \end{itemize}
    ...
    Consider the weave immediately preceding $x_1$:
    $$\underline{\lambda\overline{\eta}} \cdot u_1 \cdot \underline{x_1}$$
    where $u_1$ is a (possibly empty) \emph{spinal descent} (internal nodes).
    ...
    \item If $u_1$ is not empty then the next weave is of the form
        $$ \underline{\lambda\overline{\eta}} \cdot u_1 \cdot \underline{x_1} \cdot w \cdot \lambda\overline{\eta_2} \cdot u_2 \cdot \underline{x_2} $$
        where
        \begin{itemize}
