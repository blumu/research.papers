...
perhaps they can be modeled by non-deterministically spawning new traversals for every occurrence of the variable to be substituted.
...
It clearly appears from Example~\ref{tab:varity2_trav} that even for relatively simple terms, traversals can easily get very long. This is not surprising given that they were not designed with efficiency nor optimality in mind, but rather derived from the game-semantic analogy.
