...
\todo{Minor: re-check this proof, in particular (iii)}
\end{proof}
...
Let $q\geq 1$.
\todo{Explain where the relabelling done in $\coresymbol$ is used during trivial reduction of the qnf.
}
...
\end{theorem}
\begin{proof}
(i) \todo{Proof of (i) is a variation of Danos-Regnier proof for the same result for head-linear reduction.}
...
(iii) \todo{Hopefully the proof of (ii) should not involve state machine/stack/environments, ...}
\end{proof}
