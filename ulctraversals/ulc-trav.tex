...
Here are some thoughts on comparing (i) Daniil-Jones (DJ) traversals, (ii) Danos-Reigner's Pointer Abstract Machine (PAM) machine state runs, and (iii) Blum's ``paranormal'' and game-semantic-inspired traversals for ULC. Those are based on the conversations Neil and I had during his visit to MSR.
