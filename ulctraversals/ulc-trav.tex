...
We prove by finite induction on $q$ that $u_{\leq m_q} \in\travsetnorm$ where $m_q$'s justifying node and label are same in $u$ and $t$. For $q=0$, we just apply rule \rulenamet{Lam} on $u'$.
