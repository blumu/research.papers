...
\begin{itemize}[leftmargin=3em]
    ...
    \begin{compactitem}
        ...
        \item[\rulenamet{Lam^{\sf var}}] If $n$ is a variable then it points to the only occurrence of its binder (or the tree root, if $n$ is a free variable) occurring in $\pview{t\cdot \alpha}$;
