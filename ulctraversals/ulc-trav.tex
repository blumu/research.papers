...
(iii) idea: If $M$ is in quasi normal form then none of the traversals of $\travsetnorm(M)$ use the \rulenamet{Var} rule, therefore traversals are necessarily finite.
