...
\item If $M$ has a beta-normal form then its left-most head linear reduction terminates (and thus yields a \emph{quasi normal form}).
\end{enumerate}
\end{theorem}
\begin{proof}
...
(iii) We can either appeal to the proof argument of Danos-Regnier in~\cite{danos-head}.
\begin{todobox}
